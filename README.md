...
| [Flight Delay Prediction API](https://github.com/crystalmford/flight-delay-prediction-api) | Trained and deployed a regression model using FastAPI to predict airline arrival delays. |
