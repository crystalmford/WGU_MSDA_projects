...
# Rename columns to match model’s format
df.rename(columns={
    'DAY_OF_MONTH': 'DAY',
    'ORIGIN': 'ORG_AIRPORT',
    'DEST': 'DEST_AIRPORT',
...
# Select only relevant columns (matches the notebook)
...
def time_to_seconds(time_value):
    # Make sure time_value is treated as a string, then extract hour and minute
...
cleaned_file_path = r"C:\Users\Crystal\OneDrive\Desktop\d602\task 2\d602-deployment-task-2\data\cleaned_data_v2.csv"
